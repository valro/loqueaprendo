 ...
 *the remainder is the last digit of the octal number (1, in this case). Then
 *divide the original number by 8 and repeat the process to arrive any netx-to-
 *last digit. (printf is capable of displaying numbers in base 8, as we'll see
...
{
  int number, i1, i2, i3, i4, i5, modulus, quotient;
