...
** [[https://ezix.org/project/wiki/HardwareLiSter][Harward Lister (lshw)]]
...
* Linux Debian
** Install google chrome in Buster
...
* Linux keyboard layout
  ...
  #+END_SRC
To see what your installed keyboards are (for example to find the country code) use:
#+BEGIN_SRC sh
setxkbmap -query
#+END_SRC
...
* C Programming      
** Open Source C Libraries Repositories
   1. [[https://www.gnu.org/software/libc/manual/html_node/index.html#Top][The GNU C Library Reference Manual]]
   2. [[https://algoritmosyalgomas.com/maximo-comun-divisor-para-varios-numeros/][Maximo Comun Divisor]]
   3. [[https://en.cppreference.com/w/c/links/libs][A List of Open Source C Libraries]]
   4. [[https://www.gnu.org/software/gsl/][GSL - GNU Scientific Library]]
      The key used to sign the official releases can be found [[https://www.gnu.org/software/gsl/key/gsl_key.txt][here]].
...
[[http://ergoemacs.org/emacs/emacs_whats_hook.html][What's a hook?]]
...
Hook is similar to the concept of event in other systems. Adding functions to a hook is similar to adding event handlers. (note: emacs lisp manual also uses the term “event”, but that is lower level events to emacs (such as pressing a key), not events from emacs.)
   ...
   [[http://ergoemacs.org/emacs/emacs_hooks_list.html][list of all hooks]]

You can list all hooks with M-x apropos-variable then type -hook
...
**  how to use monospace font in tables and source code blocks in org-mode, proportional font in other parts
   [[https://yoo2080.wordpress.com/2013/05/30/monospace-font-in-tables-and-source-code-blocks-in-org-mode-proportional-font-in-other-parts/][YooBox]]
   [[https://www.emacswiki.org/emacs/SetFonts][Set Fonts]]
